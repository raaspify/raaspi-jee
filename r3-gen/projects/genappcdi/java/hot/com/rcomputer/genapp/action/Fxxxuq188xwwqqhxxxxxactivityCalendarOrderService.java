 ...
 */
@Named("fxxxuq188xwwqqhxxxxxactivityCalendarOrderService")
@Path("/activityo")
public class Fxxxuq188xwwqqhxxxxxactivityCalendarOrderService 
{
   ...
   public String getItems(@HeaderParam("Host") String hostName,@HeaderParam("Authorization") String authString)
   {
     ...
     String urlName=serverName;
      ...
      List<Object[]> items =
            entityManager.createQuery("select c.a0xxuobxbxxxxxxxxxxxsid, c.a0xxukaxbvxxxxxxxxxxactivitycode, c.c8sbcxxrlxxxxxxxxxxxeffdate from Fxxxuq188xwwqqhxxxxxactivity c  where c.zzxxu2oxxhxxxxxxxxxxowner2=:owner2 order by c.a0xxuobxbxxxxxxxxxxxsid  asc")
