...
/**
 * Xlrxeh69jxwwqqhxxxxxjjournal generated by hbm2java
 */
@Entity
@XmlRootElement
@Table(name = "jjournal")
public class Xlrxeh69jxwwqqhxxxxxjjournal implements java.io.Serializable {
	...
	private String c4xxuxexbvxxxxxxxxxxjob;
	...
	public Xlrxeh69jxwwqqhxxxxxjjournal() {
	}

	public Xlrxeh69jxwwqqhxxxxxjjournal(String a0xxujpshvxxsxxxxxxxxpostdate) {
	...
	public Xlrxeh69jxwwqqhxxxxxjjournal(String a0xxujpshvxxsxxxxxxxxpostdate,
			...
			Integer c1xxzwppbvpxxxxxxxxxperiod, String c4xxuxexbvxxxxxxxxxxjob,
		...
		this.c4xxuxexbvxxxxxxxxxxjob = c4xxuxexbvxxxxxxxxxxjob;
	...
	@Size(max = 20)
	public String getC4xxuxexbvxxxxxxxxxxjob() {
		return this.c4xxuxexbvxxxxxxxxxxjob;
	}

	public void setC4xxuxexbvxxxxxxxxxxjob(String c4xxuxexbvxxxxxxxxxxjob) {
		this.c4xxuxexbvxxxxxxxxxxjob = c4xxuxexbvxxxxxxxxxxjob;
	}
