 ...
 */
@Named("jxxxuq201xwwqqhxxxxxcustomerCalendarOrderService")
@Path("/customero")
public class Jxxxuq201xwwqqhxxxxxcustomerCalendarOrderService 
{
   ...
   public String getItems(@HeaderParam("Host") String hostName,@HeaderParam("Authorization") String authString)
   {
     ...
     String urlName=serverName;
      ...
      List<Object[]> items =
            entityManager.createQuery("select c.a0xxuobxbxxxxxxxxxxxsid, c.c1xxuslnbvixxxxxxxxxlastname ||' , ' || coalesce(c.p1xxh4pobv27xxxxxxxxphoneo,'')  , c.yfxxcxxybvxxxxxxxxxxnxtcontact from Jxxxuq201xwwqqhxxxxxcustomer c  where c.zzxxu2oxxhxxxxxxxxxxowner2=:owner2 and c.zdxxutoxlhxxxxxxxxxxowner=:owner order by c.a0xxuobxbxxxxxxxxxxxsid  asc")
