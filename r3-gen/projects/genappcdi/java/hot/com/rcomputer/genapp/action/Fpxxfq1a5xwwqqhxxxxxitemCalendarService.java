...
/**
* This gets calendar data for calendar view 
 ...
 */
@Named("fpxxfq1a5xwwqqhxxxxxitemCalendarService")
@Path("/itemt")
public class Fpxxfq1a5xwwqqhxxxxxitemCalendarService 
{
   ...
   public String getItems(@HeaderParam("Host") String hostName,@HeaderParam("Authorization") String authString)
   {
     ...
     String urlName=serverName;
      ...
      if( customIdentity.hasRole("VW") || customIdentity.hasRole("VQ") || customIdentity.hasRole("VH") || customIdentity.hasRole("PH") ){
       items =
            entityManager.createQuery("select c.a0xxuobxbxxxxxxxxxxxsid, c.a0xxukixbxxxxxxxxxxxmatcode, c.z2xxcsxrlxxxxxxxxxxxdateadded from Fpxxfq1a5xwwqqhxxxxxitem c  where c.zzxxu2oxxhxxxxxxxxxxowner2=:owner2 and c.zzxxu2oxxhxxxxxxxxxxowner2=:ownerCode order by c.a0xxuobxbxxxxxxxxxxxsid  asc")
             .setParameter("owner2", owner2Code).setParameter("owner", ownerCode).getResultList();
      }else{
       items =
            entityManager.createQuery("select c.a0xxuobxbxxxxxxxxxxxsid, c.a0xxukixbxxxxxxxxxxxmatcode, c.c2fbcxxrehxxsxxxxxxxspriceffdt from Fpxxfq1a5xwwqqhxxxxxitem c  where c.zzxxu2oxxhxxxxxxxxxxowner2=:owner2 order by c.a0xxuobxbxxxxxxxxxxxsid  asc")
