...
<jasperReport xmlns="http://jasperreports.sourceforge.net/jasperreports" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://jasperreports.sourceforge.net/jasperreports http://jasperreports.sourceforge.net/xsd/jasperreport.xsd" name="Xlrxeh685xjournal" pageWidth="1200" pageHeight="595" columnWidth="1140" leftMargin="30" rightMargin="30" topMargin="20" bottomMargin="20" resourceBundle="messages" whenResourceMissingType="Key">
	...
	<queryString>
       ...
       journal.account AS journal_account,
...
FROM
       genapp.journal journal WHERE
       (journal.jnlseq) >=  $P{Start} AND   (journal.jnlseq <= $P{End}) AND
       journal.owner2 = $P{owner2Code} order by journal.postdate,journal.jnlseq]]>
	</queryString>
	<field name="journal_sid" class="java.lang.Number"/>
	...
	<field name="journal_account" class="java.lang.String"/>
	...
	<variable name="debitt" class="java.math.BigDecimal" resetType="Group" resetGroup="bydate" calculation="Sum">
		<variableExpression><![CDATA[$F{journal_debit}]]></variableExpression>
	</variable>
	<variable name="creditt" class="java.math.BigDecimal" resetType="Group" resetGroup="bydate" calculation="Sum">
		<variableExpression><![CDATA[$F{journal_credit}]]></variableExpression>
	</variable>
	<variable name="debitgt" class="java.math.BigDecimal" incrementType="Group" incrementGroup="bydate" calculation="Sum">
		<variableExpression><![CDATA[$V{debitt}]]></variableExpression>
	</variable>
	<variable name="creditgt" class="java.math.BigDecimal" incrementType="Group" incrementGroup="bydate" calculation="Sum">
		<variableExpression><![CDATA[$V{creditt}]]></variableExpression>
	</variable>
	<group name="bydate">
		<groupExpression><![CDATA[$F{journal_postdate}]]></groupExpression>
		<groupHeader>
			<band height="24">
				<textField isBlankWhenNull="true">
					<reportElement x="27" y="3" width="100" height="20"/>
					<textElement/>
		...
		<groupFooter>
			<band height="37">
				<textField isBlankWhenNull="true">
					<reportElement x="500" y="9" width="50" height="20"/>
					<textElement/>
	...
	<pageHeader>
		<band height="37" splitType="Stretch">
			...
			<textField pattern="" isBlankWhenNull="false" hyperlinkType="LocalPage">
				<reportElement key="textField" x="389" y="8" width="50" height="16" forecolor="#000000" backcolor="#6666FF"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField pattern="" isBlankWhenNull="false" hyperlinkType="LocalPage">
				<reportElement key="textField" x="445" y="8" width="50" height="16" forecolor="#000000" backcolor="#6666FF"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField pattern="" isBlankWhenNull="false" hyperlinkType="LocalPage">
				<reportElement key="textField" x="500" y="8" width="50" height="16" forecolor="#000000" backcolor="#6666FF"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField pattern="" isBlankWhenNull="false" hyperlinkType="LocalPage">
				<reportElement key="textField" x="550" y="10" width="50" height="16" forecolor="#000000" backcolor="#6666FF"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField pattern="" isBlankWhenNull="false" hyperlinkType="LocalPage">
				<reportElement key="textField" x="688" y="9" width="50" height="16" forecolor="#000000" backcolor="#6666FF"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField pattern="" isBlankWhenNull="false" hyperlinkType="LocalPage">
				<reportElement key="textField" x="626" y="9" width="50" height="16" forecolor="#000000" backcolor="#6666FF"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
	...
	<detail>
		<band height="25" splitType="Stretch">
			<textField isBlankWhenNull="false">
				<reportElement key="textField" x="200" y="0" width="50" height="23"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField isBlankWhenNull="false">
				<reportElement key="textField" x="449" y="0" width="50" height="23"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
				...
				<textElement/>
				<textFieldExpression><![CDATA[$F{journal_account}]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="false">
				<reportElement key="textField" x="500" y="0" width="50" height="23"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField isBlankWhenNull="false">
				<reportElement key="textField" x="550" y="0" width="50" height="23"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField isBlankWhenNull="true">
				<reportElement key="textField" x="688" y="2" width="50" height="23"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField isBlankWhenNull="true">
				<reportElement x="626" y="2" width="50" height="23"/>
				<textElement/>
				<textFieldExpression><![CDATA[$F{journal_xreference}]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="false">
				<reportElement key="textField" x="325" y="2" width="50" height="23"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
			...
			<textField isBlankWhenNull="false">
				<reportElement key="textField" x="389" y="2" width="50" height="23"/>
				<box>
					<topPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<leftPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
					<bottomPen lineWidth="0.0" lineStyle="Solid" lineColor="#000000"/>
	...
	<summary>
		<band height="59" splitType="Stretch">
			<textField isBlankWhenNull="true">
				<reportElement x="506" y="14" width="70" height="20"/>
				<textElement/>
				<textFieldExpression><![CDATA[$V{debitgt}]]></textFieldExpression>
			</textField>
			<textField isBlankWhenNull="true">
				<reportElement x="576" y="14" width="100" height="20"/>
				<textElement/>
