...
<#if (menuAttributes?substring(efS,efE) == '60' || menuAttributes?substring(efS,efE) == '61') >
...
<#assign listPageName = "Reporttrialbalance">
...
<ui:define name="body">
	...
	<p:toolbar height="26" itemSeparator="grid">
	  ...
	  <p:toolbarGroup>
              <h:button id="tdoneh" image="./img/Homeblue16.png"  alt="Home" value="Home" propagation="end" outcome="/home.xhtml" />
	  </p:toolbarGroup>
	  ...
	  <p:toolbarGroup location="right">
		   <h:graphicImage id="Helpt" value="/img/help.gif" styleClass="pic" rendered="${'#'}{messages['reporttrialbalanceHelp']!=null}">
             <p:tooltip > <span style="white-space: nowrap"> <h:inputTextarea  cols="70" rows="10" readonly="true"  value="${'#'}{messages['reporttrialbalanceHelp']}"/></span> </p:tooltip> 
             </h:graphicImage>
	  </p:toolbarGroup>
       <h:messages globalOnly="true" styleClass="message" id="globalMessages"/>
	</p:toolbar>
         <#--
         until we pass a param to backing bean w reportName, leep expanded true so that reportName gets updated via jsf
         -->
         <p:panel toggleable="true" toggleableHeader="true" style="width: 20%;" header="${'#'}{messages['${entityName?substring(eL)?cap_first}']} Reports using default parameters          (Use the Browser back button after viewing or have multiple browser windows open)  " switchType="ajax" expanded="true"
     leftCollapsedIcon="/img/control_add16.png" leftExpandedIcon="/img/control_remove16.png">
           <h:panelGrid columns="1">
            ...
            <ui:decorate template="layout/display.xhtml">
                ...
                <h:selectOneMenu id="${reportName}" value="${'#'}{${listName}.${reportName}}">
                 <f:selectItem id="ritem1" itemLabel="Trial Balance" itemValue="fiTrialbalancereport" />
                </h:selectOneMenu> 
         ...
         <p:panel toggleable="true" toggleableHeader="true" style="width: 30%;" header="Click to show Report details parameters" switchType="ajax" expanded="false"
     leftCollapsedIcon="/img/control_add16.png" leftExpandedIcon="/img/control_remove16.png">
       ...
       <h:panelGrid columns="3">
        <h:panelGrid columns="2">
            <ui:decorate template="layout/display.xhtml">
                ...
                <h:selectOneMenu id="so" value="${'#'}{${customerEntityName}List.sortOrder}">
        ...
        <h:panelGrid columns="2">
            <ui:decorate template="layout/display.xhtml">
                ...
                <h:selectOneMenu id="fo" value="${'#'}{${customerEntityName}List.fontName}">
                 <ui:remove>
        ...
        <h:panelGrid columns="2">
            <ui:decorate template="layout/display.xhtml">
                <ui:define name="label">${'#'}{messages['YearEnd']}</ui:define>
                <h:inputText value="${'#'}{${accountEntityName}List.FYearEndS}"/>
            </ui:decorate>
        </h:panelGrid>
       </h:panelGrid>
       </p:panel>
