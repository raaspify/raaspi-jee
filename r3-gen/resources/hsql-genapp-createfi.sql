...
--              Z1,2,3 Tax1,2,3    
--              b1,2,3 etc usage budget amount period 1,2 , a1,2,3 etc actual  ,bt and at for total, c1,c2 etc formulae
--              wn-no invoice
...
--structure CLIENT-COMPANY-DIVISION-DEPARTMENT-ACCOUNT COMPANY 1-div1-dep1,dep2 company1-div2-dep1,2,3 
-- cc-dd-ee (01-01-01)  where cc etc  refers to company,div,dep G/L code
-- or simple caseie small business company-division-department-account
CREATE 
TABLE GENAPP. 
COMPANY 
( 
...
--USERPROFL is like extension of USER and is normally accessed via USER, so no natural key
CREATE 
TABLE GENAPP. 
USERPROFL 
( 
