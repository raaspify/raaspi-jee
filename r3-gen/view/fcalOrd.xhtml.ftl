...
<#if (pojo.shortName?length > eL)>
 ...
 <#if (menuAttributes2?substring(6,8) == '1a' | menuAttributes2?substring(6,8) == '18' | menuAttributes2?substring(6,8) == '89' 
     | menuAttributes2?substring(6,8) == '20' | menuAttributes2?substring(6,8) == '30'| menuAttributes2?substring(6,8) == '44')
     >
...
<#-- Generated By fcalOrd.xhtml.ftl on ${.now} -->
...
//                alert("Jay: function called" );
        ...
        $.ajax({
            url:'rest/${componentName?substring(eL)}o',
       ...
       //        alert("Jay suicess: " + result );
               ...
               //     alert("Jay2: " + $(this).text()) ;
                   ...
                   //    alert("Jay3: " + $(this).children("Item").text()) ;
                       events.push({
                        url: '/${entityName?substring(eL)}.wflow?${componentName}A0xxuobxbvxxxxxxxxxxsid='+$(this).children("ItemUrl").text(),
...
<p>
    ...
    <#elseif (menuAttributes2?substring(efS,efE) == '44') >
     title: ${'#'}{messages['${entityName?substring(eL)?cap_first}']} Assigned,
    <#else>
     title: ${'#'}{messages['${entityName?substring(eL)?cap_first}']} Ordered,
    </#if>
