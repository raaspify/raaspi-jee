...
FROM
       ...
       <#if propertyType== "java.lang.Integer">
        ${KeyA0Field?substring(pL)} =   $P!{ForTargetId}]]></queryString>
       <#else>
         (${KeyA0Field?substring(pL)}) =   ($P!{ForTargetId})]]></queryString>
       </#if> 
...
-->
		...
		<detail>
			<band height="19"  isSplitAllowed="true" >
				...
				<textFieldExpression   class="java.lang.String"><![CDATA[$F{${keyKField?substring(pL)}}]]></textFieldExpression>
				</textField>
				<textField isStretchWithOverflow="true" pattern="" isBlankWhenNull="true" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >
					<reportElement
						x="214"
				...
				<textFieldExpression   class="java.lang.String"><![CDATA[$F{${descriptionField?substring(pL)}}]]></textFieldExpression>
				</textField>
				<textField isStretchWithOverflow="true" pattern="" isBlankWhenNull="true" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >
					<reportElement
						x="321"
				...
				<textFieldExpression   class="java.lang.String"><![CDATA[$F{${titleField?substring(pL)}}]]></textFieldExpression>
				</textField>
				<textField isStretchWithOverflow="true" pattern="" isBlankWhenNull="true" evaluationTime="Now" hyperlinkType="None"  hyperlinkTarget="Self" >
					<reportElement
						x="428"
				...
				<textFieldExpression   class="java.lang.String"><![CDATA[$F{${lastNameField?substring(pL)}}]]></textFieldExpression>
				</textField>
			</band>
		</detail>
		<columnFooter>
