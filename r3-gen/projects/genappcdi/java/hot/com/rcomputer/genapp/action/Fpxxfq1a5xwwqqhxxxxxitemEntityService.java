 ...
 * @author 3R Computer 
 */
@Named("fpxxfq1a5xwwqqhxxxxxitemEntityService")
@ApplicationPath("rest")
@Path("/itemq")
public class Fpxxfq1a5xwwqqhxxxxxitemEntityService extends Application
{
