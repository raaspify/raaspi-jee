...
* @author 3R Computer 
*/
@Named("fxxxuq1bhxwwqqhxxxxxusagebyperiodsEntityService")
@ApplicationPath("rest")
@Path("/usagebyperiodsq")
public class Fxxxuq1bhxwwqqhxxxxxusagebyperiodsEntityService extends Application
{
   ...
   public String getItems(@HeaderParam("Host") String hostName,@HeaderParam("Authorization") String authString)
   {
     ...
     String urlName=serverName;
      ...
      // in the series
      // rest request will be /seam/resource/rest/usagebyperiodsq/{m(arked)}/a(mt)q(ty)
      //                                                                         /a(ll)/r(trn)
      //                                                                         /k(ey)xxxxx/m(isc)
      //                                                                         /m/m(etrics)
