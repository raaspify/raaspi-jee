...
<#-- Generated By gen-register.xhtml.ftl on ${.now}
-->
<#--
Register page
...
<ui:remove>
       <p:panel id="captcha">
        ...
        <f:facet name="footer">
          <h:panelGroup>
            <h:selectBooleanCheckbox id="agreedToTerms" value="${'#'}{${userEntityName}Home.agreedToTermsOfUse}"/>
            ...
            <h:button id="ltdone"  value="Cancel" propagation="end" outcome="/home.xhtml" rendered="${'#'}{!${userEntityName}Home.agreedToTermsOfUse}"
                 class="w3-btn w3-light-gray"          />
            <h:button id="ltdone2"  value="Done" propagation="end" outcome="/home.xhtml" rendered="${'#'}{${userEntityName}Home.agreedToTermsOfUse}"
                 class="w3-btn w3-light-gray" />
          </h:panelGroup>
        </f:facet>
