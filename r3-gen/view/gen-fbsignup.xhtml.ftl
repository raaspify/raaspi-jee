...
<!-- not used, replaced by socialLogin. Generated By gen-fbsignup.xhtml.ftl on ${.now}
-->
<#--
Register page
...
<ui:define name="body">
 ...
 <h:form id="register">
     <p:remoteCommand immediate="true" name="onFbLogin" ajaxSingle="true" action="${'#'}{${userEntityName}Home.onFbLogin()}"
              onclick="rc([{name: 'id', value: '${'#'}{${userEntityName}Home.fbUid}'},
                                   {name: 'email', value: '${'#'}{${userEntityName}Home.fbEmail}'},
                                   {name: 'name', value: '${'#'}{${userEntityName}Home.fbName}',
                                   {name: 'first_name', value: '${'#'}{${userEntityName}Home.fbFirst_Name}',
                                   {name: 'last_name', value: '${'#'}{${userEntityName}Home.fbLast_Name}',
                                   {name: 'gender', value: '${'#'}{${'#'}{${userEntityName}Home.fbGender}',
                                   {name: 'agree', value: '${'#'}{${userEntityName}Home.fbName},
                                   {name: 'name', value: '${'#'}{${userEntityName}Home.agreedToTermsOfUsefb}',])">
     </p:remoteCommand>
...
/// add a new method in controlusageperiods?
  ...
  <p:tab title="${'#'}{messages.or_login_signup_with_fb}" leftInactiveIcon="/img/fb29.png" > 
            <h:selectBooleanCheckbox id="agreedToTermsfb" value="${'#'}{${userEntityName}Home.agreedToTermsOfUsefb}"/>
