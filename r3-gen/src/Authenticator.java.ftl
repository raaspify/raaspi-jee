...
public class Authenticator extends BaseAuthenticator implements Serializable{
   ...
   private EntityManager entityManager;
	...
	@Inject
	${userproflEntityName?cap_first}List ${userproflEntityName}List;
	...
	${acperiodEntityName?cap_first} acperiodnew;
	@Inject
	${perioddatesEntityName?cap_first}Home ${perioddatesEntityName}Home;
	${perioddatesEntityName?cap_first} ${perioddatesEntityName};
     </#if>
     @Inject
     ${employeeEntityName?cap_first}Home ${employeeEntityName}Home;
     ${employeeEntityName?cap_first} ${employeeEntityName};
     @Inject
     ...
     ${customerEntityName?cap_first} ${customerEntityName};
     @Inject
     ${usagebyperiodsEntityName?cap_first}Home ${usagebyperiodsEntityName}Home;
     ${usagebyperiodsEntityName?cap_first} ${usagebyperiodsEntityName};
	...
	String role = "";
     ...
     private ${userEntityName?cap_first} ssoUser=null; 
     private List<${userEntityName?cap_first}> results;
     ...
     ${acperiodEntityName?cap_first} acperiod;
     ...
     try{
      ...
      if (!checkCreateTables()){
       return;
		...
		.createQuery(
		"select c from ${clientEntityName?cap_first} c where c.${clientKeyField} = :nKeyName and c.zzxxu2oxxhxxxxxxxxxxowner2 = :owner2")
 	   ...
 	   log.severe("Used locale enUSo2 after DatabaseResourceLoader error, locale was null "+emsg );
	       ...
	       ${clientEntityName}Home.setId( client.getA0xxuobxbxxxxxxxxxxxsid() );
	        ...
	        return;
			  ...
			  customIdentity.setProduct(client.get${clientProdcode?cap_first}().substring(0, 1));
			  customIdentity.setSubProduct(client.get${clientProdcode?cap_first}().substring(1, 2));
			  ...
			  customIdentity.setOwner2(owner2Code);
                          ...
                          //localeSelector.setVariant(client.get${clientProdcode?cap_first}().substring(0, 2));
 		  ...
 		  results =  entityManager
 					.createQuery(
 					"select c from ${userEntityName?cap_first} c where c.a0xxukuxbvxxxxxxxxxxid = :username and c.zzxxu2oxxhxxxxxxxxxxowner2 = :owner2 ")
 			 ...
 			 .getResultList();
                  ...
                  if(results.isEmpty() || thisUserSsoPW ){
                   ...
                   if(ssoToken !=null && !ssoToken.isEmpty()){
                     List<${clientEntityName?cap_first}> resultsC = entityManager
					.createQuery(
					"select c from ${clientEntityName?cap_first} c where c.${clientKeyField} = :nKeyName and c.h5xxuxxxivxxxxxxxxxxncode = :ssoToken")
					.setParameter("nKeyName","01")
                    ...
                    for(${clientEntityName?cap_first} ${clientEntityName}:resultsC){
	      results =  entityManager
 					.createQuery(
					"select c from ${userEntityName?cap_first} c where c.a0xxukuxbvxxxxxxxxxxid = :username and c.c4xxuxupivxxxxxxxxxxcurrpw !='ssoPW' ")
 					.setParameter("username", logonId)
 					.getResultList();
                    }
			 ...
			 if (user.getC2xxuxuaiv38xxxxxxxxalevel() != null) {
				...
				customIdentity.setRole(role.toUpperCase()); 
                 ...
                 if (user.get${employeeEntityName?cap_first}() != null) {
                  ${employeeEntityName}Home.set${employeeEntityName?cap_first}A0xxuobxbxxxxxxxxxxxsid( user.get${employeeEntityName?cap_first}().getA0xxuobxbxxxxxxxxxxxsid() );
                  ${employeeEntityName} = ${employeeEntityName}Home.getDefinedInstance();
                  String cdd="sss";
                  String suffix="";
                  if(${employeeEntityName}.get${companyEntityName?cap_first}() != null){
                   suffix=${employeeEntityName}.get${companyEntityName?cap_first}().getA0xxukcxbvxxxxxxxxxxcompanycode();
                  }
                  ...
                  suffix="";
                  if(${employeeEntityName}.get${divisionEntityName?cap_first}() != null){
                   suffix=${employeeEntityName}.get${divisionEntityName?cap_first}().getA0xxukoxbvxxxxxxxxxxdivcode();
                  }
                  if (suffix !=null && suffix.length()>0){
                  ...
                  suffix="";
                  if(${employeeEntityName}.get${departmentEntityName?cap_first}() !=null ){
                   suffix=${employeeEntityName}.get${departmentEntityName?cap_first}().getA0xxukexbvxxxxxxxxxxdepcode();
                  } 
                  if (suffix !=null && suffix.length()>0){
                   cdd=cdd+suffix.substring(suffix.length()-1,suffix.length());
                  }else{
			  ...
			  customIdentity.setOwnerSid(${employeeEntityName}.getA0xxuobxbxxxxxxxxxxxsid());
	...
	if (!checkPeriod) {
        ...
        public void createSSO(){
                       ...
                       ${userEntityName}Home.createInstance();
                       ${userEntityName}Home.getInstance().setA0xxukuxbvxxxxxxxxxxid(results.get(0).getA0xxukuxbvxxxxxxxxxxid());
                       ${userEntityName}Home.getInstance().setC1xxuxxxbvxxxxxxxxxxotherid(results.get(0).getC1xxuxxxbvxxxxxxxxxxotherid());
                       // ssouser points to customer entity, which needs to be created
                       ${userEntityName}Home.setInCreateUser(false);
                       ${userEntityName}Home.getInstance().setC4xxuxupivxxxxxxxxxxcurrpw("ssoPW");
                       ${userEntityName}Home.getInstance().setC6xxuxuoivxxxxxxxxxxoldpw(results.get(0).getZzxxu2oxxhxxxxxxxxxxowner2());
                       ${userEntityName}Home.getInstance().setY1xxuxxxivxxxxxxxxxxrestrict1(results.get(0).getY1xxuxxxivxxxxxxxxxxrestrict1());
                       ${userEntityName}Home.getInstance().setZzxxu2oxxhxxxxxxxxxxowner2(owner2Code);
                       if(urlName.startsWith("mybusiness") || urlName.startsWith("myorg") || urlName.startsWith("mycustommade")){
                        ${userEntityName}Home.getInstance().setC2xxuxuaiv38xxxxxxxxalevel("U");
                        ${userEntityName}Home.getInstance().setC3xxuxubiv39xxxxxxxxblevel("H");
                        ${userEntityName}Home.getInstance().setY1xxuxxxivxxxxxxxxxxrestrict1("D");
                       }else{
                        ${userEntityName}Home.getInstance().setC2xxuxuaiv38xxxxxxxxalevel("V");
                        ${userEntityName}Home.getInstance().setC3xxuxubiv39xxxxxxxxblevel("H");
                       }
                       ...
                       ssoUser=${userEntityName}Home.getInstance();

        }
        public void createEmpl(){
                       if(urlName.startsWith("mybusiness") || urlName.startsWith("myorg") || urlName.startsWith("mycustommade")){
                        if(results.get(0).get${employeeEntityName?cap_first}() !=null){
                         ...
                         ${employeeEntityName}Home.createInstance();
                         ${employeeEntityName}Home.getInstance().setA0xxuktxbvxxxxxxxxxxemployee(results.get(0).get${employeeEntityName?cap_first}                        ().getA0xxuktxbvxxxxxxxxxxemployee());
                         ...
                         ${userEntityName}Home.getInstance().set${employeeEntityName?cap_first}(${employeeEntityName}Home.getInstance());
                        }else{
                         ...
                         ${employeeEntityName}Home.createInstance();
                         ${employeeEntityName}Home.getInstance().setA0xxuktxbvxxxxxxxxxxemployee(subKey);
                         ${employeeEntityName}Home.getInstance().setN4xxhxxrbv24xxxxxxxximailaddr("");
                         ${employeeEntityName}Home.getInstance().setZzxxu2oxxhxxxxxxxxxxowner2(owner2Code);
                         ${employeeEntityName}Home.getInstance().setO2xxuwmrbv40xxxxxxxxintegrset("DEFAULT");
                         ${employeeEntityName}Home.persist();
                         ${userEntityName}Home.getInstance().set${employeeEntityName?cap_first}(${employeeEntityName});
                        }
                       }else{
        ...
        public void createCustAddr(){
                       if(results.get(0).get${customerEntityName?cap_first}()==null){
                        FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(
                       ...
                       if(results.get(0).get${customerEntityName?cap_first}().get${addressEntityName?cap_first}ByMailtocode() !=null){
                          addressFound=true;
                          ${addressEntityName}Home.createInstance();
                          ${addressEntityName}Home.getInstance().setA0xxukbxbxxxxxxxxxxxaddrescode(results.get(0).get${customerEntityName?cap_first}().get${addressEntityName?cap_first}ByMailtocode().getA0xxukbxbxxxxxxxxxxxaddrescode());
                          // copy other info besides key
                          ${addressEntityName}Home.getInstance().setZzxxu2oxxhxxxxxxxxxxowner2(owner2Code);
                          ${addressEntityName}Home.persist();
                          // user does not have address as foreign, only via customer

                       }
                       if(results.get(0).get${customerEntityName?cap_first}() !=null){
                         ${customerEntityName}Home.createInstance();
                         ${customerEntityName}Home.getInstance().setA0xxukxxbvxxxxxxxxxxcustomer(results.get(0).get${customerEntityName?cap_first}().getA0xxukxxbvxxxxxxxxxxcustomer());
                         if(addressFound){ 
                          ${customerEntityName}Home.getInstance().set${addressEntityName?cap_first}ByMailtocode(${addressEntityName}Home.getInstance());
                         } 
                         ${customerEntityName}Home.getInstance().setZzxxu2oxxhxxxxxxxxxxowner2(owner2Code);
                         ${customerEntityName}Home.persist();
                         ${userEntityName}Home.getInstance().set${customerEntityName?cap_first}(${customerEntityName}Home.getInstance());
	...
	public boolean checkSetAcPeriod() {
                ${acperiodEntityName?cap_first} acperiod =null;
                try {
			acperiod = (${acperiodEntityName?cap_first}) entityManager
					.createQuery(
                <#if keyAutoGen=="Y"> 
							"select c from ${acperiodEntityName?cap_first} c where c.a0xxukwpbv47xxxxxxxxrowid = :rowid and c.zzxxu2oxxhxxxxxxxxxxowner2 = :owner2" )
                <#else>
							"select c from ${acperiodEntityName?cap_first} c where c.id.a0xxukwpbv47xxxxxxxxrowid = :rowid and c.id.zzxxu2oxxhxxxxxxxxxxowner2 = :owner2" )
                </#if>
					.setParameter("owner2", owner2Code)
					.setParameter("rowid", "01").getSingleResult();
			           ...
			           if (acperiod != null & acperiod.getA0xxukwpbv47xxxxxxxxrowid() != null) {
                           <#else>
 			           if (acperiod != null & acperiod.getId().getA0xxukwpbv47xxxxxxxxrowid() != null) {
                           </#if>
		...
		.createQuery(
                                         <#if keyAutoGen=="Y"> 
                  	"select c from ${perioddatesEntityName?cap_first} c where c.zzxxu2oxxhxxxxxxxxxxowner2 = :owner2 and :toDay between cast(c.b2xxdwsrbvxxxxxxxxxxstartdate as date) and cast(c.b3xxdwerbvxxxxxxxxxxenddate as date)")
   	                  .setParameter("toDay", toDay, TemporalType.DATE)
		  .setParameter("owner2", owner2Code)
		         .getSingleResult();
                                         <#else>
		"select c from ${perioddatesEntityName?cap_first} c where c.id.zzxxu2oxxhxxxxxxxxxxowner2 = :owner2 and :toDay between cast(c.b2xxdwsrbvxxxxxxxxxxstartdate as date) and cast(c.b3xxdwerbvxxxxxxxxxxenddate as date")
		        .setParameter("toDay", toDay, TemporalType.DATE)
		        .setParameter("owner2", owner2Code)
		        .getSingleResult();
                                        </#if>
                                        <#if keyAutoGen=="Y"> 
			                 if (${perioddatesEntityName}.getA0xxukwpbv47xxxxxxxxperiod() != null) {
					  currdivperiod = ${perioddatesEntityName}.getA0xxukwpbv47xxxxxxxxperiod();
					  currdivperioddescript = ${perioddatesEntityName}.get${perioddatesDescript?cap_first}();
                                        <#else>
 			                 if (${perioddatesEntityName}.getId().getA0xxukwpbv47xxxxxxxxperiod() != null) {
					  currdivperiod = ${perioddatesEntityName}.getId().getA0xxukwpbv47xxxxxxxxperiod();
					  currdivperioddescript = ${perioddatesEntityName}.getId().get${perioddatesDescript?cap_first}();
                                        </#if>
                                         }
					...
					acperiod.set${acperiodDescript?cap_first}(currdivperioddescript);
				       }
				       if (bcontinue) {
					...
					Calendar nextDay = (Calendar) calendar.clone();
                                        ...
                                        if(nextDay.equals(${perioddatesEntityName}.getB3xxdwerbvxxxxxxxxxxenddate()) 
                                         || nextDay.after(${perioddatesEntityName}.getB3xxdwerbvxxxxxxxxxxenddate()) ){
                                         FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(
					 ...
					 acperiod.setB2xxdwerbvxxxxxxxxxxcurrbusdate(nextDay.getTime());
				        ...
				        if ( acperiod != null){
                                         ${acperiodEntityName}Home.setInstance(acperiod);
					 ${acperiodEntityName}Home.update();
        ...
        public String setClientChosenSkin(String viewUrl){
          ...
          // set skin to client default value evenif not logged in via home.xhtml f:metadata tag f:preRenderView listener
  	         ...
  	         customIdentity.setOwner2(owner2Code);// use customIdentity owner2Code instead of checking in each bean and xhtml
                 ...
                 client =(${clientEntityName?cap_first}) entityManager
	.createQuery(
	"select c from ${clientEntityName?cap_first} c where ${clientKeyField} = :nKeyName and c.zzxxu2oxxhxxxxxxxxxxowner2 = :owner2")
	.setParameter("nKeyName","01")
	.setParameter("owner2", owner2Code)
	.getSingleResult();
	} catch (Exception ex) {
	...
	return "";
                 ...
                 usagebyperiods =(${usagebyperiodsEntityName?cap_first}) entityManager
					.createQuery(
					"select c from ${usagebyperiodsEntityName?cap_first} c where c.a0xxukupbvxxxxxxxxxxusagetrackerid = :nKeyName and c.zzxxu2oxxhxxxxxxxxxxowner2 = :owner2")
        ...
        public void setUserChosenSkin(){
          ...
          // look into using menu font style as well but need to increase field sizes
                 if(skinBean.getSkint() !=null){
                  ...
                  return;
                      ...
                      if(${userproflEntityName}==null){
                       ...
                       try{          
                        ${userproflEntityName}=${userproflEntityName}Home.createInstance();
			 ...
			 log.severe("Error accessing userprofl"+ e);
                      ...
                      if(${userproflEntityName} != null && this.country !=null && !this.country.isEmpty()){
                         ${userproflEntityName}.setC3xxuxxrbvxxxxxxxxxxp1(this.country.toLowerCase()); 
                         ${userproflEntityName}Home.setInstance(${userproflEntityName});
                         ${userproflEntityName}Home.update();
                      } 
		      if (${userproflEntityName} != null) {
                       if(${userproflEntityName}.getB1xxuxxrbvxxxxxxxxxxscrcolor() != null && !${userproflEntityName}.getB1xxuxxrbvxxxxxxxxxxscrcolor().isEmpty()){
                        if(skinBean.ContainsSkin(${userproflEntityName}.getB1xxuxxrbvxxxxxxxxxxscrcolor())){
                         skinBean.setSkin(${userproflEntityName}.getB1xxuxxrbvxxxxxxxxxxscrcolor());
    
                        }else{
                         FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(
                         FacesMessage.SEVERITY_INFO,bundle.getString("invalid")+" "+bundle.getString("user")+" "+bundle.getString("theme")+" "+bundle.getString("value")+" "+${userproflEntityName}.getB1xxuxxrbvxxxxxxxxxxscrcolor()+", "+bundle.getString("updated")+" "+bundle.getString("to")+" "+bundle.getString("default")+" "+bundle.getString("value")+" "+"r3WhiteModern",""));
                         ${userproflEntityName}.setB1xxuxxrbvxxxxxxxxxxscrcolor("r3WhiteModern"); 
                         ${userproflEntityName}.setC3xxuxxrbvxxxxxxxxxxp1(this.country.toLowerCase()); 
                         ${userproflEntityName}Home.setInstance(${userproflEntityName});
                         ${userproflEntityName}Home.update();
                         skinBean.setSkin(${userproflEntityName}.getB1xxuxxrbvxxxxxxxxxxscrcolor());
