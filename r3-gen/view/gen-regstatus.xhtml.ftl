...
<#-- Generated By gen-regstatus.xhtml.ftl on ${.now}
Home page
parameters passed: none
popupPanels: none
todo: copy signup code from gen-home.xhtml it is on the menu
-->
<ui:define name="body">
	...
	<p:toolbar height="26" itemSeparator="grid">
	  ...
	  <p:toolbarGroup location="right">
             <h:commandButton id="About" value="Help" alt="Help" action="${'#'}{${controlusagebyperiodsEntityName}List.print}" image="/img/About16.gif" >
...
<h:form  >
 ...
 <p:dialog id="forgotPanel" widgetVar="forgotPanel" modal="true" width="360" height="240" show="${'#'}{${userEntityName}Home.forgotPasswordError}" rendered="${'#'}{not identity.loggedIn}"
...
<#--remove
      <ui:decorate id="lostPasswordEmailField" template="layout/edit.xhtml">
      <ui:define name="label">${'#'}{messages.login_email}</ui:define>
       <h:inputText id="lostPasswordEmail" required="true" value="${'#'}{${userEntityName}Home.lostPasswordEmail}"/>
      </ui:decorate>
-->
...
<h:form  >
 ...
 <p:dialog id="pswdRecovered" widgetVar="pswdRecovered" modal="true" width="360" height="260" rendered="${'#'}{not identity.loggedIn}" show="${'#'}{${userEntityName}Home.recoveredPasswordEmail != null}"
                       domElementAttachment="parent">
