...
@Path("/vendorq")
public class Jxxxuq300xwwqqhxxxxxvendorEntityService extends Application
{
   ...
   public String getItems(@HeaderParam("Host") String hostName,@HeaderParam("Authorization") String authString)
   {
     ...
     String urlName=serverName;
      ...
      // in the series
      // rest request will be /seam/resource/rest/vendorq/{m(arked)}/a(mt)q(ty)
      //                                                                         /a(ll)/r(trn)
      //                                                                         /k(ey)xxxxx/m(isc)
      //                                                                         /m/m(etrics)
