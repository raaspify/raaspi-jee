...
public class R3RestClientAddon extends R3RestClient implements java.io.Serializable{
...
*/
    ...
    public void doQuickRegister() {
	    ...
	    yxxxuh566xwwqqwxxxxxuser.setC3xxuxubiv39xxxxxxxxblevel("H");
            ...
            // also account,acintgr,acperiod will be cloned from 3rcomp owner2 to new account owner2
            // either add setter in userhome for inregistrationxxx,subKey or call doregisterfrom which sets these values
            subKey="manager";
		   ...
		   log.severe("in case clob not saved,debug code "+"/"+owner2CodeClient+","+yxxxuh566xwwqqwxxxxxuser.getY7xxuxznbvxxxxxxxxxxnotes()+" xx:"+savedActivationKey);//continue, user need not know
             ...
             ////yxxxuh566xwwqqwxxxxxuserHome.registrationScreenName = null;
             // add creating record 02 and put shopify access_token in secret, record 02 can be used for paypal
                 try{
