 ...
 */
@Named("trexuq444xwwqqhxxxxxemplordersCalendarOrderService")
@Path("/emplorderso")
public class Trexuq444xwwqqhxxxxxemplordersCalendarOrderService 
{
   ...
   public String getItems(@HeaderParam("Host") String hostName,@HeaderParam("Authorization") String authString)
   {
     ...
     String urlName=serverName;
      ...
      List<Object[]> items =
            entityManager.createQuery("select c.a0xxuobxbxxxxxxxxxxxsid, to_char(c.b1xxcxxxbvxxxxxxxxxxdelvdatet,'''D''ue Mon-DD ') || coalesce((select i.b1xxuszsbvxxxxxxxxxxdescript  from Fpxxfq1a5xwwqqhxxxxxitem i where c.fpxxfq1a5xwwqqhxxxxxitem=i.a0xxuobxbxxxxxxxxxxxsid),'') || coalesce((select e.b3xxuslnbvixxxxxxxxxlastname  from Jxxxbh400xwwqqhxxxxxemployee e where c.jxxxbh400xwwqqhxxxxxemployeeByEmployee=e.a0xxuobxbxxxxxxxxxxxsid),'')  , c.b1xxcxxxbvxxxxxxxxxxdelvdatet from Trexuq444xwwqqhxxxxxemplorders c  where c.zzxxu2oxxhxxxxxxxxxxowner2=:owner2  order by c.a0xxuobxbxxxxxxxxxxxsid  asc")
