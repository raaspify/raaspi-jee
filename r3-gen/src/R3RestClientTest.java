package com.rcomputer.genapp.test;
...
public class R3RestClientTest implements java.io.Serializable{
	...
	private Yxxxuq1n1xwwqqqxxxxxblobdata yxxxuq1n1xwwqqqxxxxxblobdata;
     ...
     CustomIdentity customIdentity;
      ...
      private FacesContext facesContext=null;
               ...
               String serverName="";
               private Boolean tomeeYN = false;//sep21 2021 bypass openshift router logic for now until logic aded
               private String hostingAt = "op";//oct12 2021 op for openshift, aw for amazon aws, hero for heroku, lo for Local
    ...
    public void initialize() {
      ...
      if(facesContext !=null){
       ...
       hostingAt=context.getInitParameter(hostingAt);//oct12 2021
       requestH = (HttpServletRequest) externalContext.getRequest();
       serverName=context.getServerInfo();//sep21 2021 check if tomcat or wildfly
       ...
       urlName=((javax.servlet.http.HttpServletRequest) externalContext.getRequest()).getServerName();
          ...
          owner2CodeApp=owner2CodeApp.replace(".l3recommerce","");
          owner2CodeApp=owner2CodeApp.replace(".3recommerce","");
          owner2CodeApp=owner2CodeApp.replace(".lraaspi","");
          owner2CodeApp=owner2CodeApp.replace(".raaspi","");
    ...
    */
         ...
         //apr02 2020 https://www.raaspi.com/installApp.wflow?hmac=cff6d0008412ac800facedabc3bc3654846f8fce9fcedd0bf88e5a4f95197033&shop=cometojo.myshopify.com&timestamp=1585872363
         ...
         public String installOrAuthorize(){
          ...
          if(facesContext !=null){
           ...
           externalContext = facesContext.getExternalContext();
           requestH = (HttpServletRequest) externalContext.getRequest();
           //apr02 2020  owner2CodeApp value needs to be reestablished if multiple use in same session
           urlName=((javax.servlet.http.HttpServletRequest) externalContext.getRequest()).getServerName();
			...
			.getSingleResult();
		      ...
		      if (client != null) {
		       ...
		       int mstatusfl=client.getZexxzzfxhhxxxxxxxxxxstatusfl();
                       ...
                       redirect_uri="https://www.raaspi.com/installApp.wflow";
                       String state="001";
                       ...
                       yxxxch522xhhxxhxxxxxclientHome.update();
                        ...
                        FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(
                         FacesMessage.SEVERITY_ERROR,bundle.getString("please")+" "+bundle.getString("notify")+" "+bundle.getString("raaspi")+" "+bundle.getString("support"),""));
		 ...
		 ClientResponse<String> response = request.post(String.class);
                ...
                //jul14 2019 put doquickRegister here to create new site  after merchant installs app
                 ...
                 doQuickRegister();
                  ...
                  // feb03 2020 installAppStaus expects xxx not xxx.myshopify.com.
                 ...
                 if(clientJustCreated ){
                  //apr19 2020 put 3 secs delay to avoid edge route not set up
                  try{
         ...
         public String installOrAuthorizeGMail(){
          ...
          if(requestH == null ){
		   ...
		   ClientResponse<String> response = request.post(String.class);
                   ...
                   //jan05 2019 ya29.Il-4B6rI-sJZwQoNeGBNSgujnayJzBT0lm4u23pEXxfgSOexr5d0RjnDX3VWHuArgkm7bBAiwmoCNF_wTt-dVteFsw-d3--qUkJK05WNcBpqtNQ8Vl51kq48dUFpImwt2A
		      ...
		      if (client != null) {
		       ...
		       int mstatusfl=client.getZexxzzfxhhxxxxxxxxxxstatusfl();
                      ...
                      if (client_id ==null || client_id.isEmpty() ){
                        ...
                        //apr10 2020 emailrender expects non empty value in rec07 client id
...
//////////////////////////////////////////
     ...
     try{
      ...
      String host=uri.getHost();
          ...
          if (host.contains("www.")){
           owner2Code=host.substring(4,urlIndex);//apr10 2020
          }else{
           owner2Code=host.substring(0,urlIndex);
          }

      //remove subdomain if raaspi or lraaspi
    ...
    String getUrl(String owner2){
     int urlPort=((javax.servlet.http.HttpServletRequest) externalContext.getRequest()).getServerPort();
     String owner2_url="raaspi";
     if(owner2==""){
      owner2="myorgp";
     }
     if(urlPort==8080){
      owner2_url=owner2+".lraaspi.com:8080";
     }else{
      owner2_url=owner2+".raaspi.com";
     }
             ...
             Fpxxfq1a5xwwqqhxxxxxitem categoryItem=null;
		      ...
		      if (client != null) {
               ...
               return null;
                ...
                //may05 2018 accesstoken recvd e25b608df4cbd55b4598ebc0a2a141d0
		...
		while ((output = br.readLine()) != null) {
              ...
              try{
                   ...
                   for (int i =0;i<row.get("variants").getAsJsonArray().size();i++){
                    ...
                    //may11 2020 to avoid subcategories without variant, description called default Title via customstrategy
                    ...
                    }//may09 2010 same as dateadded to avoid null value
                ...
                for (Fxxxuq111xwwqqhxxxxxaddress address : addresses){
                   ...
                   if(addressP !=null){
                    ...
                    // we need to populate foreign fields using raaspi data ex ship address,billing address,
                      ...
                      //sept24 2018 get customer first
               ...
               // ex matCode from line_items can be used in order and also in cuodetails
                ...
                for (Trexuq244xwwqqhxxxxxcuorders order : orders){
                   ...
                   if(orderP !=null && orderP.getA0xxuobxbxxxxxxxxxxxsid()!=null ){
                    nnew=false;
                    //sept26 2018 if update we should use existing orderP as base and change those values coming
...
//---------------------end of cuodetail--------------------
      ...
      if(clientOwner2.equals("shopId")){
       ...
       return null;
		 ...
		 request = new ClientRequest(ret);
                 ...
                 //mar 10 2019 add logic with a flag to add refresh_token along with id,secret and code if partnrer secret has changed
		 ...
		 ClientResponse<String> response = request.post(String.class);
                 ...
                 if(action.equals("c")){
                  ...
                  try{
                   ...
                   //yxxxuq1m1xwwqqqxxxxxclobdataHome.addonCreateInstance();
    ...
    */
     ...
     public String shoauthverify(){
      //jul17 2019 not used any more, logic is part of installorauth method
      facesContext = FacesContext.getCurrentInstance();
      if(facesContext !=null){
       bundle = facesContext.getApplication().getResourceBundle(facesContext, "messages");
       externalContext = facesContext.getExternalContext();
...
*/
    ...
    public void doQuickRegister() {
         ...
         try{
          ...
          if(!clientExists){
             //feb 12 2019 6 paramters, last param ie usage/prodcode applicationFunction is used to set if empty
             ...
             //yxxxuh566xwwqqwxxxxxuserHome.addonCreateInstance();
             ...
             if (smtpEnabled) {
                ...
                //savedActivationKey=yxxxuh566xwwqqwxxxxxuserHome.addonGetMD5Hash(yxxxuh566xwwqqwxxxxxuser.getA0xxukuxbvxxxxxxxxxxid() + clientName + email + System.currentTimeMillis());
	     ...
	     yxxxuh566xwwqqwxxxxxuser.setC3xxuxubiv39xxxxxxxxblevel("H");
             ...
             yxxxuh566xwwqqwxxxxxuserHome.setClientApplicationFunction("eege");//aug09 2019 set client prodcod
		   ...
		   log.severe("in case clob not saved,debug code "+"/"+owner2CodeClient+","+yxxxuh566xwwqqwxxxxxuser.getY7xxuxznbvxxxxxxxxxxnotes()+" xx:"+savedActivationKey);//continue, user need not know
             ...
             //may072018 add creating record 02 and put shopify access_token in secret, record 02 can be used for paypal
                 try{
                  ...
                  //yxxxch522xhhxxhxxxxxclientHome.addonCreateInstance();
                  ...
                  //mar22 2020 automate openshift router create. openAuthorize method here is also called by doRegister
    ...
    public void callDoSiteCreate(String email,String siteName,String couponId) {
     ...
     //nov08 2020 in redeem siteName > userHome.setClientApplicationName, which has logic to check for extra suffix
   ...
   public Yxxxuh566xwwqqwxxxxxuser getUserByCustomerSid(int customerSid){
          Yxxxuh566xwwqqwxxxxxuser user=null;
           String owner2Code="raaspi";//user n customer were created in raaspi
          try{
         ...
         try{
            ...
            String savedActivationKey=null;
             ...
             if(sItemSid.equals("S") && yxxxuq591xwwqqhxxxxxrate1f.getA0xxukxxbvxxxxxxxxxxusertype().equals("SC")){
              sItemSid="281";
              //nov06 2020 causes persist yxxxuq591xwwqqhxxxxxrate1f.setB2xxuxxrbv51xxxxxxxxstepname(sItemSid);
             }
             if(sItemSid ==null
               || sItemSid.isEmpty()){
              FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(
             ...
             try{//nov04 2020 coupons type SC means stepName is item sid ie numeric, also temp bypass
          ...
          if(facesContext !=null){
           ...
           serverName=requestH.getServerName();
                  ...
                  //oct22 2020 automate openshift router create. openAuthorize method here is also called by doRegister
                  //in DoRegister it used to quit at this point and manual  process in sqladmin created route
                  // and then called eMailReadyToActivate which copyDefaultsToOwner2 and copyOptions and then sent email  ..
                  // now openAuthorize (also called by doRegister) will automate create route and calling emailreadytoactivate
                  client01=yxxxch522xhhxxhxxxxxclientList.getKeyToEntity("01",owner2CodeClient);
...
//       add api for oc delete route kaitoys.raaspi.com , use loglevel 9 to see the api calls
			...
			.getSingleResult();
		      ...
		      if (client != null) {
		       ...
		       int mstatusfl=client.getZexxzzfxhhxxxxxxxxxxstatusfl();
                       if (isBitSet(mstatusfl, _mpartial)){
                        FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(
                         FacesMessage.SEVERITY_ERROR,bundle.getString("raaspi")+" "+bundle.getString("app")+" "+bundle.getString("temporarily")+" "+bundle.getString("stopped")+bundle.getString("for")+bundle.getString("maintenance"),""));
                        return null;
		       }
                       if (isBitSet(mstatusfl, _mclosed) ){
                        FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(
			...
			.getSingleResult();
		      ...
		      if (client != null) {
		       ...
		       int mstatusfl=client.getZexxzzfxhhxxxxxxxxxxstatusfl();
                       ...
                       client_p=client.getDbxxuzxdssxxxxxxxxxxapiclientsecret().replace("\r","");//apr21 2020 route private key
                      ...
                      if(debug){//oct09 2021 need not be error, assume automated router only if record 08/09/10 exists
		 ...
		 ClientResponse<String> response = request.post(String.class);
                 ...
                 //mar29 2020 although inRegistrationAndCreateUser was set in doQuickRegister value is not retained?
                 yxxxuh566xwwqqwxxxxxuserHome.setInRegistrationAndCreateUser(true);
     ...
     public String manageDns(String nameServerBy){
      //Mar 14 2020 clone of shopify logic
      /*
