...
<#if (menuAttributes2?substring(efS,efE) == '60' || menuAttributes2?substring(efS,efE) == '61')  >
...
<#assign listPageName = "Reportbalancesheet">
...
<ui:define name="body">
	...
	<p:toolbar height="26" itemSeparator="grid">
	  ...
	  <p:toolbarGroup>
              <h:button id="tdoneh" image="./img/home_24.png"  alt="Home" value="Home" propagation="end" view="/home.xhtml" />
	  </p:toolbarGroup>
	  ...
	  <p:toolbarGroup location="right">
		   <h:graphicImage id="Helpt" value="/img/help.gif" styleClass="pic" rendered="!${'#'}{messages['reportbalancesheetHelp']}=null">
             <p:tooltip > <span style="white-space: nowrap"> <h:inputTextarea  cols="70" rows="10" readonly="true"  value="${'#'}{messages['reportbalancesheetHelp']}"/></span> </p:tooltip> 
             </h:graphicImage>
           ...
           <h:panelGrid columns="1">
            <ui:decorate template="layout/display.xhtml">
                ...
                <h:selectOneMenu id="${reportName}" value="${'#'}{${listName}.${reportName}}">
                 <f:selectItem id="ritem1" itemLabel="Balance Sheet" itemValue="fiBalancesheetreport" />
                </h:selectOneMenu> 
       ...
       <h:panelGrid columns="3">
        ...
        <div class="actionButtons">
         <h:panelGrid columns="8">      
            <h:commandButton id="report" value="Generate Report"  styleClass="buttonMain" onclick="this.form.target='_blank'"  action="${'#'}{${listName}.rollnPrint}"/>
...
<#assign propertyPath = property.name + '.' + parentPojo.identifierProperty.name>
        ...
        <p:column>
            ...
            <h:link view="/${'#'}{empty from ? '${pageName}' : from}.xhtml" 
                   value="Select" 
                      id="${componentName}">
...
<#else>
    ...
    <div class="tableControl">
        ...
        <h:link view="/${listPageName}.xhtml" 
