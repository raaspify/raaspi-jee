 ...
 */
@Named("trxxuq9aaxwwqqhefxxxjobassignmentCalendarService")
@Path("/jobassignmentt")
public class Trxxuq9aaxwwqqhefxxxjobassignmentCalendarService 
{
   ...
   public String getItems(@HeaderParam("Host") String hostName,@HeaderParam("Authorization") String authString)
   {
     ...
     String urlName=serverName;
      ...
      List<Object[]> items =
            entityManager.createQuery("select   s.a0xxuobxbxxxxxxxxxxxsid,s.a0xxukxxbvxxxxxxxxxxjobassign, s.b5gxdxsdbvxxxxxxxxxxsdatet from Trxxuq9aaxwwqqhefxxxjobassignment s where s.zzxxu2oxxhxxxxxxxxxxowner2=:owner2 order by s.a0xxukxxbvxxxxxxxxxxjobassign  asc")
