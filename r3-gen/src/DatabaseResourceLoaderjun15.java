...
public DatabaseResourceLoader() {
 	  ...
 	  log.severe("calling new DbControl w rbLocale "+rbLocale );
 	 ...
 	 //log.severe("setParent in resourceBundle error "+e.getMessage() );
 	  ...
 	  log.severe("calling new DbControl again w locale "+locale );
  ...
  protected Object handleGetObject(String key) {
   ...
   /// itself
 	  log.severe("handleGetObject will do parent.getObject w key "+key );
