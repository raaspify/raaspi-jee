...
<#assign listPageName = "Reportjournalbyaccount">
...
<ui:define name="body">
	...
	<p:toolbar height="26" itemSeparator="grid">
	  ...
	  <p:toolbarGroup location="right">
		   <h:graphicImage id="Helpt" value="/img/help.gif" styleClass="pic" rendered="!${'#'}{messages['reportjournalbyaccountHelp']}=null">
             <p:tooltip > <span style="white-space: nowrap"> <h:inputTextarea  cols="70" rows="10" readonly="true"  value="${'#'}{messages['reportjournalbyaccountHelp']}"/></span> </p:tooltip> 
             </h:graphicImage>
	  </p:toolbarGroup>
           ...
           <h:panelGrid columns="1">
            <ui:decorate template="layout/display.xhtml">
                ...
                <h:selectOneMenu id="${reportName}" value="${'#'}{${listName}.${reportName}}">
                 <f:selectItem id="ritem1" itemLabel="Journal By Account" itemValue="fiJournalbyaccountreport" />
                </h:selectOneMenu> 
            ...
            <h:panelGrid columns="2">
                 <h:selectOneMenu  value="${'#'}{${listName}.start}" 
                  ...
                  <f:selectItems value="${'#'}{${listName}.getSuggestList(${homeName}.prefix)}" var="result"
                   itemValue="${'#'}{result.b5cczjsibvxxxxxxxxxxjnlseq}" itemLabel="${'#'}{result.b6xxzkjsbvxxxxxxxxxxjnlseqs}" />
                 </h:selectOneMenu>
            </h:panelGrid>
