 ...
 * @author 3R Computer 
 */
@Named("jxxxbh400xwwqqhxxxxxemployeeEntityService")
@ApplicationPath("rest")
@Path("/employeeq")
public class Jxxxbh400xwwqqhxxxxxemployeeEntityService extends Application
{
   ...
   public String getItems(@HeaderParam("Host") String hostName,@HeaderParam("Authorization") String authString)
   {
     ...
     String urlName=serverName;
      ...
      int i=0;
        items = entityManager.createQuery("select c.a0xxuobxbxxxxxxxxxxxsid, c.a0xxuktxbvxxxxxxxxxxemployee, c.z2xxztqxlvxxxxxxxxxxempltqty from Jxxxbh400xwwqqhxxxxxemployee c  where c.zzxxu2oxxhxxxxxxxxxxowner2=:owner2 order by c.zfxxcztxlxxxxxxxxxxxstatusfldt  desc").setMaxResults(6)
      ...
      // in the series
      // rest request will be /seam/resource/rest/employeeq/{m(arked)}/a(mt)q(ty)
      //                                                                         /a(ll)/r(trn)
      //                                                                         /k(ey)xxxxx/m(isc)
      //                                                                         /m/m(etrics)
