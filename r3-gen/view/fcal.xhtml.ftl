	...
	<p:toolbar height="26" itemSeparator="grid">
	  ...
	  <p:toolbarGroup>
              ...
              <#if (menuAttributes2?substring(6,8) == '89' | menuAttributes2?substring(6,8) == '9a' ) >
               <h:outputText value=" Tips: click on a date to create event and click again to give details and save" style="font-weight: normal;" rendered="${'#'}{!yxxxuh566xwwqqwxxxxxuserHome.mobile}"/> 
              </#if>
	  </p:toolbarGroup>
	  ...
	  <p:toolbarGroup>
              ...
              <#if (menuAttributes2?substring(6,8) == '89' | menuAttributes2?substring(6,8) == '9a' ) >
               <h:outputText value=" Tips: click on a date to create event and click again to give details and save" style="font-weight: normal;" /> 
              </#if>
	  </p:toolbarGroup>
	  <p:toolbarGroup location="right">
